...
import {LabelHelperPlane} from "../LabelHelper"
...
function AngleVisual(options)
{
  ...
  const DEFAULTS = {
    ...
    , direction: new THREE.Vector3(1,0,0)//should this be oposite angle ?
  ...
  this.label = new LabelHelperPlane({text:"",fontSize:this.fontSize,bgColor:this.textBgColor})
  this.label.hide()
  this.add( this.label )
  //this.setLabelType()
  ...
  this.midEndLine = new SizeHelper( { 
