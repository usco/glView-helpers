...
function drawLinkToLinkedClones(object) {
  ...
  if (!lClones) {
    /*console.log("no linked clones");*/return;
  };
...
if (undefined.selectedObjects.length > 0 && undefined.selectedObjects[0].lClones || undefined.selectedObjects[0].parent.parent._original) {
  if (undefined.selectedObjects[0].cloneLink) undefined.selectedObjects[0].remove(undefined.selectedObjects[0].cloneLink);
  drawLinkToLinkedClones(undefined.selectedObjects[0]);
}